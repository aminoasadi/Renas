...
async function main() {
    ...
    await prisma.siteSettings.upsert({
        ...
        create: {
            ...
            defaultSeoDescription: "RENAS connects industrial buyers with evaluated suppliers and manages sourcing, verification, regional trade execution and delivery.",
